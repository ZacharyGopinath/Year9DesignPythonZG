...
'''
This function takes 2 numeric values and calculates the volume
of a cylinder. It returns the volume. If the passed parameters 
are invalid it returns -1
'''
...
def calcVolumeCylinder(radius, height):
 ...
 #Main Code
root =  tk.Tk()
 #Build the widgets and place the in the root before
 #the mainloop in 3 steps
 #Step 1
#Construct the widget
 #Step 2
#Configure the widget
 #Step 3
#Place the widget in the root, pack it
